...
export class AboutAditya extends Component {
    ...
    return (
        <>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className=" font-medium">DevOps Engineer</span> currently working at Avathon I've completed 2 years at  <u className=' cursor-pointer '> <a href="https://avathon.com/" target={"_blank"}>Avathon</a> </u>, and now I'll be pursuing my Masters in Cybersecurity at USYD! ( Hit me up <a className='text-underline' href='mailto:ibetanibex@gmail.com'><u>@ibetanibex@gmail.com</u></a> :) )</li>
                <li className=" mt-3 list-building"> I enjoy playing with the terminal and Building ML/DL models.</li>
                <li className=" mt-3 list-time"> When I am not coding my next project, I like to attend and speak at events , hangout with my friends, Mentor students, you will find my youtube channel here  <a href="https://www.youtube.com/channel/UCG0iRAooRqLAdbVVf33-e3w" target="_blank" rel="noreferrer"> where all my sessions are uploaded.</a></li>
                <li className=" mt-3 list-star"> And I also have interest in Cybersecurity and OpenSource!</li>
            </ul>
        </>
    )
}
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                <li className="list-disc">
                    ...
                    <div className=" text-sm md:text-base">Information Science</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">GPA &nbsp; 4.0/4.0</div>
                </li>
                <li className="list-disc mt-5">
                    <div className=" text-lg md:text-xl text-left font-bold leading-tight">
                        Kendriya Vidyalaya Malleswaram Class 10-12<sup>th</sup>
                    </div>
        ...
        <>
            ...
            <ul className=" tracking-tight text-sm md:text-base w-10/12 emoji-list">
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    I know basics of C,C++,Java and in depth knowledge in Python in terms of programming languages and bash,shell scripting and command line interface.
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <div> My areas of expertise are <strong className="text-ubt-gedit-orange">Devops, AI/ML,DL & Cybersecurity!</strong></div>
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
    ...
    const project_list = [
        {
            ...
            date: "Apr 2025",
            link: "https://github.com/adi271001/adi271001.github.io",
            description: [
        ...
        },
        {
            name: "CodexSearch",
            date: "Oct 2023",
            link: "https://github.com/adi271001/CodexSearch",
            description: [
            ...
            domains: ["python", "app/website"]
        },
        {
            name: "Bone Marrow Cells Classification using Deep Learning",
            date: "Oct 2023",
            link: "https://github.com/adi271001/Bone-Marrow-Cells-classification",
            description: [
                "This repository contains Python code for a deep learning project that focuses on the classification of bone marrow cells using medical imaging data.",
            ],
            domains: ["python", "deep learning"]
        },
        {
            name: "Lung and Colon Cancer Detection",
            date: "Oct 2023",
            link: "https://github.com/adi271001/lung-and-colon-cancer-detection",
            description: [
                "This project aims to detect lung and colon cancer from histopathological images using deep learning techniques.",
            ],
            domains: ["python", "deep learning"]
        },
        {
            name: "Image-AND-Video-Colorizer",
            date: "May 2023",
            link: "https://github.com/adi271001/Image-AND-Video-Colorizer",
            description: [
                "A deep learning model which colorizes old photos using inpainting concept",
            ],
            domains: ["python", "deep learning"]
        }
    ];
