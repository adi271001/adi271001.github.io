...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["books", "projects", "personal-documents", "skills", "languages", "PDPU", "interests", "whoami", "cat about.txt", "cat skills.txt", "exit" ],
            PDPU: ["DevOps Engineer"],
            ...
            whoami: ["Aditya D. | DevOps Engineer" ],
            cat about.txt: ["DevOps Engineer at the Avathon 2 years of experience"],
            cat skills.txt: ["Python", "PyTorch", "OpenCV", "FastAPI", "Ansible", "Solidity", "Docker", "Kubernetes" , "Terraform", "Jenkins", "ArgoCD", "Graphana", "Prometheus", "GitOps" ],
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-aditya, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-aditya":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-aditya");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-aditya, todoist, trash, settings, sendmsg ]";
                }
                break;
